...
<p align="left">
  <img 
    src="https://readme-typing-svg.herokuapp.com?font=Poppins&size=25&pause=1000&color=A9A9A9&width=340&lines=Forever+Learner;Software+Developer;JavaScript+Enthusiast;Postgrad+Student" 
    alt="Typing SVG"
  />
</p>

<p>
I'm passionate about technology and currently deepening my skills in <strong>JavaScript</strong> and <strong>TypeScript</strong>, working with modern frameworks like <strong>React</strong> and <strong>Next.js</strong> to build clean, maintainable web applications. I'm actively developing portfolio projects that demonstrate strong fundamentals, thoughtful structure, and a practical approach to solving real-world problems.
</p>
